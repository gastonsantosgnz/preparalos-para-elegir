...
En el capítulo anterior hablamos del proceso de elegir. De los tres pasos para tomar una buena decisión. De los tests vocacionales. De los criterios para la decisión final.

Pero hay algo que necesitas saber antes de que tu hijo llegue a ese momento: \textbf{las cosas no siempre salen como uno espera.}

Y cuando eso sucede, tu forma de responder va a determinar si tu hijo sale fortalecido o destruido de la experiencia.

\vspace{0.5cm}

Como docente, he tratado con cientos de alumnos a lo largo de los años. Y algo que he aprendido a ver claramente es la diferencia entre un joven que tiene respaldo emocional en casa y uno que no lo tiene. Se nota en su desempeño, en cómo enfrenta los retos, en cómo se relaciona con otros.

\textbf{Tener el respaldo de mamá y papá puede cambiarlo todo.}

No se trata de evitarles todos los golpes. Se trata de caminar con ellos mientras los enfrentan. De estar presentes sin controlar. De acompañar sin abandonar.

Y eso es exactamente lo que tu hijo va a necesitar de ti cuando las cosas no salgan como esperaba: \textbf{presencia sin control, expectativas sin presión, apoyo sin condiciones}.

\vspace{0.5cm}

Este capítulo es tu preparación para esos momentos. No para asustarte, sino para equiparte.

Porque estas situaciones son más comunes de lo que crees. Y cuando las entiendes bien, dejan de ser tragedias y se convierten en oportunidades de crecimiento —tanto para tu hijo como para ti.

\textbf{La diferencia casi nunca está en la severidad del problema. Está en cómo los padres responden.}

\section{Cuando las cosas no salen como esperabas}

Antes de entrar a los escenarios específicos, necesito que entiendas algo importante.

Cuando un joven elige mal su carrera —o cuando la vida simplemente no sale como esperaba— pueden suceder varias cosas. Ninguna es el fin del mundo, pero cada una tiene sus propios riesgos y requiere una respuesta diferente del padre.

\textbf{Estos escenarios no son fracasos distintos. Son manifestaciones distintas del mismo proceso de madurez.}

Y en cada uno, la pregunta que debes hacerte como padre no es ``¿qué hizo mal mi hijo?'', sino: \textbf{``¿Qué está aprendiendo mi hijo aquí? ¿Qué carácter se está formando o evitando?''}

Esa perspectiva cambia todo.

\subsection{El golpe que nadie espera}

Antes que nada, quiero que entiendas algo: lo que voy a describir aquí \textbf{le pasa a muchas familias}. No es señal de que fallaste como padre. No es señal de que tu hijo es un fracasado. Es simplemente parte del proceso de crecer y encontrar el camino.
...
La buena noticia es que todas estas situaciones tienen solución. Y la forma en que las manejes puede convertir un momento difícil en un punto de inflexión positivo para tu hijo.

\vspace{0.5cm}

Déjame mostrarte los tres escenarios más comunes que he observado. No para asustarte, sino para que estés preparado. Porque si alguno de estos sucede, vas a saber exactamente cómo responder.
...
Cuando un estudiante deja una carrera trunca, el golpe emocional es brutal. No es solo que ``no le gustó'' la carrera. Es que su autoestima quedó dañada. Hay un sentido de fracaso. Ve a sus amigos avanzando mientras él se quedó atrás.
...
Si tu hijo estudió Derecho pero ahora quiere dedicarse al marketing digital, va a estar compitiendo con personas que sí estudiaron Comunicación, Mercadotecnia, Diseño. Ellos tienen ventajas: formación específica, contactos en la industria, vocabulario técnico, un título que les abren puertas.
...
Eso no es imposible. Mucha gente lo hace con éxito. Pero \textbf{se pudieron haber ahorrado 4 o 5 años} si hubieran tomado el tiempo desde el inicio para pensar bien qué querían.

\vspace{0.5cm}

Ahora bien, también hay que ser justos: a veces necesitas vivir una experiencia para saber que no era para ti.

Hay cosas que no puedes saber hasta que las vives. Puedes investigar una carrera, hablar con profesionales, hacer prácticas... y aun así, no es lo mismo que estar adentro. A veces tienes que probar algo para darte cuenta de que no era lo tuyo. Y eso no es tiempo perdido —es información valiosa.

\textbf{Progreso no es solo saber qué SÍ quieres, sino también descubrir qué NO quieres.}
...
Tuve un alumno que estudió y terminó Contaduría porque sus papás tenían un despacho y ``era lo lógico''. Sacó buenas calificaciones. Hizo su servicio social. Se tituló. Todo bien.

Y nunca ejerció un solo día como contadora.
